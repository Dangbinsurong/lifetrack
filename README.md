...
Модуль привычек позволяет создавать привычки, просматривать список привычек, фиксировать выполнение привычки по дате и получать статистику за 7 или 30 дней.

Прогресс выполнения привычки выводится в консоли в виде текстовой шкалы.


## Управление данными

Модуль управления данными позволяет создавать резервные копии базы данных, экспортировать данные в JSON, создавать ZIP-архив с JSON-дампом и копией базы SQLite, а также импортировать данные из ранее созданного ZIP-архива.

Резервные копии сохраняются в папку `backups/`, а экспортированные файлы — в папку `exports/`.